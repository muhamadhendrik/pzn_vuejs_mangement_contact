    ...
    <div class="p-8">
      ...
      <div class="mb-6 pb-6 border-b border-gray-700">
        <div class="flex items-center">
          ...
          <div>
            <h2 class="text-xl font-semibold text-white">{{ `${contact.first_name} ${contact.first_name}` }}</h2>
        ...
        <div class="mb-5">
          ...
          <div class="relative">
            ...
            <input type="text" id="street" name="street"
                   ...
                   placeholder="Enter street address" value="123 Main St" required v-model="address.street">
          </div>
        </div>
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input type="text" id="city" name="city"
                     class="w-full pl-10 pr-3 py-3 bg-gray-700 bg-opacity-50 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                     placeholder="Enter city" value="New York" required v-model="address.city">
            </div>
          </div>
          <div>
            ...
            <div class="relative">
              ...
              <input type="text" id="province" name="province"
                     class="w-full pl-10 pr-3 py-3 bg-gray-700 bg-opacity-50 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                     placeholder="Enter province or state" value="NY" v-model="address.province">
            </div>
          </div>
        </div>
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input type="text" id="country" name="country"
                     class="w-full pl-10 pr-3 py-3 bg-gray-700 bg-opacity-50 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                     placeholder="Enter country" value="USA" v-model="address.country">
            </div>
          </div>
          <div>
            ...
            <div class="relative">
              ...
              <input type="text" id="postal_code" name="postal_code"
                     class="w-full pl-10 pr-3 py-3 bg-gray-700 bg-opacity-50 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                     placeholder="Enter postal code" value="10001" v-model="address.postal_code">
            </div>
          </div>
        </div>
